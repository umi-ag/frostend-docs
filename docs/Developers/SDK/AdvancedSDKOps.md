...
The FrostEnd SDK is designed to not only make transaction, but also do a lot more such as getting gas estimation, getting parameters to call the corresponding contract, and even getting the intermediate calculation results. 

Here is how we can do it.

## The magic `method` parameter

Suppose that we want to add liquidity to the [PT stETH Pool](https://app.frostend.com/pro/pools/0xc374f7ec85f8c7de3207a10bb1978ba104bda3b2/zap/in?chain=ethereum) with 5 ETH. We can do so as follow.

```ts
import { toAddress, BN, NATIVE_ADDRESS_0x00, Router } from '@frostend/sdk-v2';
...
`method`**.  You can pass in the additional `{ method }` in most of the [FrostEnd
...
The return type of the function with `callStatic` method will have the return type of the corresponding contract. In this case, the function calls the [RouterContract] method [frostend-contract-addLiquiditySingleToken].
...
[
  ...
  },
  {
    ...
    frostendSwap: '0x0000000000000000000000000000000000000000',
    swapData: {
      swapType: 0,
...
The return type will be a tuple, which is the list of parameters to be passed to the corresponding contract if you are using Ethers.js. Note that the `overrides` field is also returned. In this case, the function calls the [RouterContract] method [frostend-contract-addLiquiditySingleToken].

### `meta-method` method

This is a powerful method of the FrostEnd SDK.
...
[api-MetaMethodType]: https://umi-labs.github.io/frostend-sdk-core-v2-public/types/MetaMethodType.html

[api-Router]: https://umi-labs.github.io/frostend-sdk-core-v2-public/classes/Router.html

[api-Router-addLiquiditySingleToken]: https://umi-labs.github.io/frostend-sdk-core-v2-public/classes/Router.html#addLiquiditySingleToken

[api-ContractMetaMethod]: https://umi-labs.github.io/frostend-sdk-core-v2-public/classes/ContractMetaMethod.html

[RouterContract]: https://etherscan.io/address/0x0000000001e4ef00d069e71d6ba041b0a16f7ea0#code

[frostend-contract-addLiquiditySingleToken]: https://github.com/umi-ag/frostend-core-v2-public/blob/310bcc9e419b2122eaf65fd283f809023ceddae6/contracts/router/ActionAddRemoveLiq.sol#L209

    ...
    <div className={styles.root}>
      ...
      <div className={styles.leftFeatureCard}>
          ...
          <Link to="/Introduction" className={styles.subFeatures}>
            ...
            <Link to="/ProtocolMechanics/Mechanisms/FROSTNED" className={styles.indivFeature}>
              <div
                onMouseEnter={() => {
                  play("governance");
                }}
              ...
              >
                ...
                <div className={styles.featureTitle}>FROSTNED</div>
              </div>
            </Link>
          </Link>
        </div>
          ...
          <Link to="/ProtocolMechanics/YieldTokenization/SY" className={styles.subFeatures}>
            ...
            <Link to="/ProtocolMechanics/AMM" className={styles.indivFeature}>
              ...
              >
                ...
                <div className={styles.featureTitle}>FrostEnd AMM</div>
              </div>
            </Link>
          </Link>
        </div>
